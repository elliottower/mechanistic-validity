...
docs/                           Astro-based documentation site
  src/content/docs/
    framework/                  THE FRAMEWORK (the core contribution)
      ...
      criteria/                 30 operational criteria organized by validity type
        construct/              C1-C5 (falsifiability, structural plausibility, etc.)
        internal/               I1-I10 (necessity, sufficiency, specificity, consistency, confound control, epistatic interaction, rescue reversibility, confounding sensitivity, knockout ordering, instrument validity)
...
- Criteria IDs (C1-C5, I1-I10, E1-E6, M1-M6, V1-V5) are stable identifiers
