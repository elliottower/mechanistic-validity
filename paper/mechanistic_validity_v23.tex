...
\paragraph{Unattempted criteria (M7, I6, I10).}  Selection correction is reported at
every claim and required at none.  It bounds how much of a result belongs to the
search rather than to the model, which is worth knowing and is not a precondition
for the result being real; and since it is Untested in all sixteen claims,
requiring it for a tier would empty the ladder without discriminating along it.
